...
class Ubicaciones extends Model
{
    ...
    public function registrarUbicacion($gps,$ip){
        ...
        $ubicacionData = [
            ...
            "latitud"=> (isset($gps["location"]["lat"]) && is_numeric($gps["location"]["lat"])) ? $gps["location"]["lat"] : $data["latitude"],
            "longitud"=> (isset($gps["location"]["lng"]) && is_numeric($gps["location"]["lng"])) ? $gps["location"]["lng"] : $data["longitude"],
